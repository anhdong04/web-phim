// Web Phim v6.1.1 launcher.
// Builds on v6.1 and hotfixes HH3D catalog visibility + manifest caching.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.1.1 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV611);
