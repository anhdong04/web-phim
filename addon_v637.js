// Web Phim v6.3.7 launcher.
// Builds on v6.3.6 and preserves YanHH3D Dailymotion playback headers for Nuvio Desktop/libmpv.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.3.7 patch target missing: v4.1 final eval');
  process.exit(1);
}
const runV637 = [
...
launcher = launcher.replace(finalEval, runV637);
eval(launcher);
