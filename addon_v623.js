// Web Phim v6.2.3 launcher.
// Builds on v6.2.2 and fixes HH3D root-first PikPak folder discovery.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2.3 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV623);
