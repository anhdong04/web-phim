// Web Phim v6.2.0 launcher.
// Builds on v6.1.2 and exposes HH3D as a fully standalone addon at /hh3d/manifest.json.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV620);
