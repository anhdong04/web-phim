// Web Phim v6.1.2 launcher.
// Builds on v6.1.1 and gives every managed share manifest a unique addon ID.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.1.2 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV612);
