// Web Phim v6.3.9 launcher.
// Builds on v6.3.8 and delivers YanHH3D Dailymotion fallback as progressive MP4 for Nuvio Desktop.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.3.9 patch target missing: v4.1 final eval');
  process.exit(1);
}
const runV639 = [
...
launcher = launcher.replace(finalEval, runV639);
eval(launcher);
