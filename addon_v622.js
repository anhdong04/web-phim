// Web Phim v6.2.2 launcher.
// Builds on v6.2.1 and fixes HH3D with fast folder-first PikPak catalog + bounded diagnostics.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2.2 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV622);
