...
const { isAllowedOkcdnUrl, rewriteOkRuPlaylist } = require('../hhtq_okru_proxy');
...
assert.match(out, /\/hhtq\/okru\/[A-Za-z0-9_-]+/);
...
console.log('hhtq OK.ru Render proxy tests: PASS');
