...
// and exposes isolated /vn, /hhkungfu and /iptv bridges for Render services
...
if (!launcher.includes(finalEval)) {
  console.error('v6.4.1 patch target missing: v4.1 final eval');
  process.exit(1);
}
const runV641 = [
...
launcher = launcher.replace(finalEval, runV641);
eval(launcher);
