// Web Phim v6.2.4 launcher.
// Builds on v6.2.3 and adds HH3D smart artwork matching + fallback posters.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2.4 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV624);
