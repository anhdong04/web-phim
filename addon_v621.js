// Web Phim v6.2.1 launcher.
// Builds on v6.2.0 and fixes live PikPak hosts/root-share scanning + diagnostics.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2.1 patch target missing: v4.1 final eval');
  process.exit(1);
}
...
launcher = launcher.replace(finalEval, runV621);
