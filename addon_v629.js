// Web Phim v6.2.9 launcher.
// Builds on v6.2.8 and normalizes disguised FB-CDN HLS child media for Nuvio.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.2.9 patch target missing: v4.1 final eval');
  process.exit(1);
}
const runV629 = [
...
launcher = launcher.replace(finalEval, runV629);
eval(launcher);
