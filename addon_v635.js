// Web Phim v6.3.5 launcher.
// Builds on v6.3.4 and sends compatible Dailymotion HLS directly to Nuvio/MPV.
...
if (!launcher.includes(finalEval)) {
  console.error('v6.3.5 patch target missing: v4.1 final eval');
  process.exit(1);
}
const runV635 = [
...
launcher = launcher.replace(finalEval, runV635);
eval(launcher);
